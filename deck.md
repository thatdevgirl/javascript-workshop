<a name="opening"></a>
## Opening: Greetings + The GA Experience (5 min)
...
Turn to the person next to you and together navigate some more through [lyft.com](https://www.lyft.com/).
...
> Instructor Note: Have students open Sublime and type their pseudocode in the text editor.  Then have students share their answers - focus on the logic.  5 min working; 5 minutes summary.

<a name="demo2"></a>
## Demo: Variables, Data Types and Arithmetic (10 minutes)
...
## Guided/Independent Practice: Variables (10 min)
...
## Guided/Independent Practice: jQuery Code Along Part 1 (15 min)
...
## Guided Practice/Independent Practice: jQuery Code Along Part 2 (10 min)
